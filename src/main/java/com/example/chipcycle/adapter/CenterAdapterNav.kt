...
import com.example.chipcycle.databinding.CenterCardNavBinding

import com.example.chipcycle.models.LocationResponseCenters

class CenterAdapterNav(private var centerList: List<LocationResponseCenters>,  private val onCenterClicked: (LocationResponseCenters) -> Unit) :
    RecyclerView.Adapter<CenterAdapterNav.CenterViewHolder>() {

    class CenterViewHolder(private val binding: CenterCardNavBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CenterViewHolder {
        val binding = CenterCardNavBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    fun updateData(newcenterList: List<LocationResponseCenters>) {
        ...
        Log.i("UserAdapaterLogs",centerList.toString())
